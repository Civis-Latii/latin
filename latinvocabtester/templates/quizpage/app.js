...
async function next_question() {
    ...
    const response = await fetch("https://Latium.eu.pythonanywhere.com/next_question", {
        method: "POST",
        headers: JSON_header,
        body: JSON.stringify({
...
async function skip_question() {
    const response = await fetch("https://Latium.eu.pythonanywhere.com/skip_question", {
        method: "POST",
        headers: JSON_header,
        body: JSON.stringify({
            "session_ID": session_ID
...
async function update_quiz_stats() {
    ...
    const response = await fetch("https://Latium.eu.pythonanywhere.com/quiz_stats", {
        method: "POST",
        headers: JSON_header,
        body: JSON.stringify({
            "session_ID": session_ID
...
async function check_answer() {
    const response = await fetch("https://Latium.eu.pythonanywhere.com/check_answer", {
        method: "POST",
        headers: JSON_header,
        body: JSON.stringify({
            "session_ID": session_ID,
...
elements.test_same_vocab.addEventListener("click", async function() {
    await fetch("https://Latium.eu.pythonanywhere.com/next_steps", {
        method: "POST",
        headers: JSON_header,
        body: JSON.stringify({
            "session_ID": session_ID,
